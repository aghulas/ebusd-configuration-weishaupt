...
print (hex(calculate_weishaupt_crc_multi("0105")))
print (hex(calculate_weishaupt_crc_multi("06000105")))
print (hex(calculate_weishaupt_crc_multi("06010105")))
print (hex(calculate_weishaupt_crc_multi("06020105")))
print (hex(calculate_weishaupt_crc_multi("06030105")))