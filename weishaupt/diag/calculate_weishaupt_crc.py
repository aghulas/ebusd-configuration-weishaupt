...
print (hex(calculate_weishaupt_crc_multi("015f")))
print (hex(calculate_weishaupt_crc_multi("02a9")))
print (hex(calculate_weishaupt_crc_multi("02aa")))
print (hex(calculate_weishaupt_crc_multi("02ab")))
print (hex(calculate_weishaupt_crc_multi("02ac")))
